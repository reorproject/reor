...
export const registerStoreHandlers = (
  ...
  ipcMain.handle('get-embedding-models', () =>
    store.get(StoreKeys.EmbeddingModels),
  );
  ...
  ipcMain.handle('get-no-of-rag-examples', () =>
    store.get(StoreKeys.MaxRAGExamples),
  );
  ...
  ipcMain.handle('get-default-embedding-model', () =>
    store.get(StoreKeys.DefaultEmbeddingModelAlias),
  );
  ...
  ipcMain.handle('get-display-markdown', () =>
    store.get(StoreKeys.DisplayMarkdown),
  );
