      ...
      <div className="ml-6 mt-2 mb-6 h-full w-[800px] max-h-[90vh] overflow-y-auto overflow-x-hidden p-4">
        ...
        <div className="flex">
          ...
          <div className="flex-1 pr-4">
            <h3 className="text-white text-lg mb-2">Select files for context</h3>
          ...
          <div className="flex flex-col items-center justify-center mx-4">
            <div className="w-px bg-gray-600 flex-grow" />
          ...
          >
            ...
            <div>
              <div className="text-gray-500 text-xs underline cursor-pointer mb-2" onClick={handleAdvancedToggle}>
