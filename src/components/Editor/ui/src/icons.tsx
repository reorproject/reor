...
export function CitationsIcon({ color = DefaultIconColor, size = '1em', ...props }) {
  return (
...
export function HistoryIcon({ color = DefaultIconColor, size = '1em', ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
      <g stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.2} clipPath="url(#a)">
...
export function CollaboratorsIcon({ color = DefaultIconColor, size = '1em', ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
...
export function CommentsIcon({ color = DefaultIconColor, size = '1em', ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
      <path
        fill={color}
