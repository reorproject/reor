  ...
  return (
    <div className="w-full bg-neutral-800 rounded text-gray-100">
      ...
      <p className="mt-2 text-sm text-gray-100 mb-1">
        ...
        <ExternalLink href="https://ollama.com">Ollama</ExternalLink>. To get
        Reor to use your Nvidia or AMD GPU, you will need to install Ollama and
        make sure that it is running at the same time as Reor is. Check out
        Ollama&apos;s{" "}
        <ExternalLink href="https://github.com/ollama/ollama/blob/main/docs/gpu.md">
          docs page
        </ExternalLink>{" "}
        for more info on configuring your GPU.
      </p>
    </div>
  );
};
