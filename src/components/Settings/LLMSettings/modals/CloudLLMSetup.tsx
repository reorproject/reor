  ...
  return (
    <ReorModal isOpen={isOpen} onClose={handleSave}>
      <div className="w-[300px] ml-3 mr-2 mb-2">
        <h3 className="font-semibold mb-0 text-white">{LLMDisplayName} Setup</h3>
        <p className="text-gray-100 mb-2 mt-2 text-sm">Enter your {LLMDisplayName} API key below:</p>
        <input
          type="text"
