  ...
  return (
    <ReorModal isOpen={isOpen} onClose={saveModelConfigToElectronStore}>
      <div className="w-[400px] ml-2 mr-2 mb-2 pl-3">
        <h3 className="text-white font-semibold mb-0">Upload and attach local model</h3>
        <p className="text-white text-xs mb-6 mt-2">Download a ONNX embedding model and select its directory below:</p>
